...
Example 1 - Метод map Нехай функція getModels повертає масив моделей (поле model) всіх автомобілів.
...
console.table(filterByPrice(cars, 30000)); console.table(filterByPrice(cars, 25000)); -->
